...
writes CarMessages.v {
	...
	@thread
	@generated("blockdiagram", "21d47eac")
	public void calc() {
		myTime = P.millis(); // Main/calc 1
		CarMessages.v = myDrive_3_instance.v; // Main/calc 2
		myDrive_3_instance.move(CarMessages.brake, CarMessages.power, DeltaTimeService.deltaT, TrackSize, Landscape.getAt(myDrive_3_instance.s)); // Main/calc 3
		dTime = (myTime - P.millis()); // Main/calc 4
	}
