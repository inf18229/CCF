...
writes CarMessages.v {
	...
	@thread
	@generated("blockdiagram", "8b255a80")
	public void calc() {
		CarMessages.v = myDrive_3_instance.v; // Main/calc 1
		myDrive_3_instance.move(CarMessages.brake, CarMessages.power, DeltaTimeService.deltaT, TrackSize, Landscape.getAt(myDrive_3_instance.s)); // Main/calc 2
	}
